...
// Auth gérée par middleware.ts (src/middleware.ts)
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  // Middleware garantit qu'on est authentifié ici
  const admin = await getAdminFromCookie();

  // Fallback si admin null (ne devrait pas arriver grâce au middleware)
